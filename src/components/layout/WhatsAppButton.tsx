...
export function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-30 isolate flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg transition-transform hover:scale-110 active:scale-95"
    >
      {/* Pulse ring */}
